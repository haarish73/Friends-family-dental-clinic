...
const Home = () => {
  ...
  const faqData = [
    ...
    },
    {
      ...
      answer: "Our clinic is open Monday through Saturday from 9:00 AM to 8:00 PM, and Sundays from 10:00 AM to 2:00 PM."
    },
    {
      question: "What modes of payment are acceptable at Friends Family Dental Clinics?",
      answer: "We accept Cash, Credit/Debit Cards, UPI payments (Google Pay, PhonePe, Paytm), and major health insurance plans."
    },
    {
      question: "How frequently should I visit a dentist?",
      answer: "We recommend scheduling a checkup and professional cleaning every 6 months to maintain optimal oral health."
    },
    {
      question: "What are the safety measures adopted by Friends Family Dental?",
      answer: "We follow strict 4-step sterilization protocols, single-use disposable kits, and complete personal protective equipment for all staff."
    }
  ];
    ...
    <div className="page-wrapper">
      ...
      <section className="hero-carousel">
        <div className="carousel-container">
          ...
          <div className={`slide-content img-${slides[currentSlide].imagePosition}`}>
      ...
      <section className="why-trust-section">
        <div className="container">
          <div className="section-header">
            ...
            <p>Committed to providing compassionate, safe, and personalized care.</p>
          </div>
      ...
      <section className="expertise-section">
        <div className="container">
          <div className="section-header">
            ...
            <p>Comprehensive dental services designed to restore and enhance your smile.</p>
          </div>
          ...
          <div className="expertise-grid">
            <div className="expertise-card">
              ...
              <p>Routine checkups, deep cleaning, cavity fillings, and preventive oral health assessments.</p>
            </div>
            <div className="expertise-card">
              <div className="card-icon">✨</div>
              <h3>Cosmetic Dentistry</h3>
              <p>Professional teeth whitening, porcelain veneers, and complete digital smile design.</p>
            </div>
            <div className="expertise-card">
              <div className="card-icon">😁</div>
              <h3>Orthodontics</h3>
              <p>Traditional braces, clear aligners, and bite correction tailored to your needs.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="callback-section">
        <div className="container callback-container">
          <div className="callback-text">
            ...
            <p>Leave your contact information below and our dental experts will get in touch shortly.</p>
          </div>
          ...
          <form className="callback-form" onSubmit={handleFormSubmit}>
            ...
            <button type="submit" className="btn-secondary">Request Call</button>
          </form>
        </div>
      </section>
